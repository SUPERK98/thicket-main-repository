...
```
2023.10  ─────── 기획·설계·Flow Chart 작성
2023.11  ─────── MSA 구조 설계, 각 서비스 기초 CRUD 구현
2023.12  ─────── Kafka 파이프라인, CTS 알고리즘, 정렬 로직 구현
2024.01  ─────── 부하 테스트, 리팩토링, 문서화·발표 자료 완성
```
